...
/** A single log entry emitted by the app.logStream IPC event. */
export type HermesLogEntry = {
...
/** Aggregated token usage for insights/monitoring. */
export type HermesUsageSnapshot = {
  /** UTC day string (YYYY-MM-DD). */
  date: string;
  totalInputTokens: number;
  totalOutputTokens: number;
  /** Estimated cost in USD; may be 0 if cost data unavailable. */
